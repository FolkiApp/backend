  ...
  describe('execute', () => {
    ...
    it('should re-throw NotFoundPostException without wrapping', async () => {
      ...
      try {
        ...
        expect((error as NotFoundPostException).code).toBe(
          'NOT_FOUND_POSTS_EXCEPTION',
        );
      }
    });
    ...
    it('should re-throw UnauthorizedPostException without wrapping', async () => {
      ...
      try {
        ...
        expect((error as UnauthorizedPostException).code).toBe(
          'UNAUTHORIZED_POST_EXCEPTION',
        );
      }
    });
  });
